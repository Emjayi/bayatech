...
export default function ElevatorLoading() {
  ...
  const isVisible = isPastHero && !isIdle;

  return (
    <motion.div
      initial={{ opacity: 0, y: -100 }}
      animate={{ opacity: isVisible ? 1 : 0.06, y: isVisible ? 0 : -20 }}
      transition={{ duration: isVisible ? 0.4 : 0.8, ease: [0.25, 0.1, 0.25, 1] }}
      className="fixed inset-0 h-[360vh] w-full bg-transparent pointer-events-none z-40"
    >
